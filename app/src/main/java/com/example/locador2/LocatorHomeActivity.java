...
public class LocatorHomeActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_locator_home);
    ...
    private void showDialogUpload() {
        AlertDialog.Builder builder = new AlertDialog.Builder(LocatorHomeActivity.this);
            ...
            if(item.getItemId() == R.id.nav_sign_out)
            {
                ...
                builder.setTitle("Sign out")
                        ...
                        .setPositiveButton("SIGN OUT", (dialogInterface, i) -> {
                            ...
                            Intent intent = new Intent(LocatorHomeActivity.this,SplashScreenActivity.class);
                ...
                dialog.setOnShowListener(dialogInterface -> {
                    //Fix deprecated
                    dialog.getButton(AlertDialog.BUTTON_POSITIVE)
                            .setTextColor(ContextCompat.getColor(LocatorHomeActivity.this,android.R.color.holo_red_dark));
                    dialog.getButton(AlertDialog.BUTTON_NEGATIVE)
                            .setTextColor(ContextCompat.getColor(LocatorHomeActivity.this,R.color.colorAccent));
                });
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.locator_home, menu);
        return true;
    }
