...
import com.example.locador2.Utils.UserUtils;
...
public class SplashScreenActivity extends AppCompatActivity {
    ...
    DatabaseReference locatorInfoRef;
...
//       database = FirebaseDatabase.getInstance();
        database = FirebaseDatabase.getInstance("https://estacionamento-64541-default-rtdb.firebaseio.com/");
        locatorInfoRef = database.getReference(Common.LOCATOR_INFO_REFERENCE);
    ...
    private void checkUserFromFirebase() {
        locatorInfoRef.child(FirebaseAuth.getInstance().getCurrentUser().getUid())
            .addListenerForSingleValueEvent(new ValueEventListener() {
                ...
                public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                    if(dataSnapshot.exists())
                    {
                        ...
                        LocatorInfoModel locatorInfoModel = dataSnapshot.getValue(LocatorInfoModel.class);
                        goToHomeActivity(locatorInfoModel);
                    }
                    else
                    {
                        showRegisterLayout();
    ...
    private void goToHomeActivity(LocatorInfoModel locatorInfoModel) {
        Common.currentUser = locatorInfoModel; // Init value
        startActivity(new Intent(SplashScreenActivity.this,LocatorHomeActivity.class));
        finish();
    }
    ...
    private void showRegisterLayout() {
        ...
        btn_continue.setOnClickListener(view -> {
            ...
            {
                LocatorInfoModel model = new LocatorInfoModel();
    ...
    private void showLoginLayout() {
        AuthMethodPickerLayout authMethodPickerLayout = new AuthMethodPickerLayout
                .Builder(R.layout.layout__sign_in)
